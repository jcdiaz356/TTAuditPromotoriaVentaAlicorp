...
public class ClientePerfectoActivity extends Activity {

    private Activity myActivity = this ;
    private static final String LOG_TAG = ClientePerfectoActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cliente_perfecto);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                // loadLoginActivity();
                    ...
                    intent = new Intent(myActivity, ClientePerfectoLavanderiaActivity.class);
